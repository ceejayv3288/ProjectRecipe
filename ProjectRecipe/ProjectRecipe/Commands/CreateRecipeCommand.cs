...
namespace ProjectRecipe.Commands
{
    public class CreateRecipeCommand : ICommand
    {
        ...
        public CreateRecipeCommand(object viewModel)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            {
                recipeCreateUpdatePageViewModel.ExecuteCreateRecipeCommand();
            }
            else if (_viewModel is MyOwnRecipesPageViewModel myOwnRecipesPageViewModel)
            {
